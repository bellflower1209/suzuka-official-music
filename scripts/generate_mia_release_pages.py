...
{related_cards(song['related'])}
    ...
    <footer class="artist-profile-footer toriatsukai-footer"><a href="../../">SUZUKA</a><span>{song['name']} · ENOMOTO MIA</span><a href="#top">Back to top ↑</a><nav class="site-footer-nav" aria-label="フッターナビゲーション"><a href="../../">Home</a><a href="../../artists/">Artists</a><a href="../../releases/">Releases</a><a href="../../news/">News</a><a href="{CHANNEL}" target="_blank" rel="noreferrer">YouTube <span aria-hidden="true">↗</span></a></nav></footer>
  </main>
